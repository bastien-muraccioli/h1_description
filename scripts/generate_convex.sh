...
export robot_name="h1"
export current_path="$(pwd)"                # You must run this script from the h1_description root directory
export sample_points=4000                   # Number of points to sample on each mesh (used for convex hull generation)
